...
# for ba in ['PACE']:
    ...
    data_pivot = data_sel.pivot(index='Week_no', columns='Weekday-Hour', values='Demand (MW) (Adjusted)') # Pivot from hourly rows to weekly rows
    ...
    print(f'Processing demand ramp data...')
